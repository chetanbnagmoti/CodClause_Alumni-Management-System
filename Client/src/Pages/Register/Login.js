...
import { userloginfunc } from "../../Services/API/Apis";
...
const Login=()=>{
  ...
  const handleLogin=async()=>{
       //  console.log(email,password);
         ...
         let result=await userloginfunc(data);
      //   console.log(result);
         const name=result.data.fname;
      //   console.log(name);
         if(name){
            ...
            if(isAdmin){
          //    console.log("True  admin :- ",isAdmin);
              navigate('/');

            }else{
          //    console.log("False Admin :- ",isAdmin);
              navigate('/')
            }
